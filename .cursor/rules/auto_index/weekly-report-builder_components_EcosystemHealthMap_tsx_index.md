# weekly-report-builder/components/EcosystemHealthMap.tsx 函数索引

> 自动生成于 2026-04-23 | 总行数: 749 | 函数数: 10 | 语言: typescript
...
| EcosystemHealthMap | function | `EcosystemHealthMap({ data, className = '' }: EcosystemHealthMapProps)` |  |
