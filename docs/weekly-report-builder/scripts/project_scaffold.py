...
PROJECT_TYPES = {
    ...
    "pre-launch": {
        "label": "上线前/研发期",
        "description": "多模块并行开发，功能点驱动里程碑，无业务数据，关注研发进度、阻塞风险、排期健康",
        "sections": [
            {"id": "hero",       "label": "首屏总览",       "required": True},
            {"id": "health",     "label": "研发健康度",     "required": True},
            {"id": "north-star", "label": "整体研发进度",   "required": True},
            {"id": "milestones", "label": "功能点里程碑",   "required": True},
            {"id": "modules",    "label": "模块开发详情",   "required": True},
            {"id": "risks",      "label": "阻塞项与风险",   "required": True},
        ],
        "module_alias": {
            "modules":                  "开发模块",
            "module.name":              "模块名称",
            "module.owner":             "模块负责人",
            "module.progress":          "功能完成率",
            "module.currentFocus":      "本周开发重点",
            "module.nextMilestone":     "下一功能节点",
            "module.metrics":           "研发指标",
            "milestones":               "功能点",
            "milestone.title":          "功能点名称",
            "milestone.version":        "所属模块",
            "northStar.metric":         "整体功能完成率",
            "risks":                    "阻塞项",
            "risk.title":               "阻塞原因",
            "risk.mitigation":          "解除方案",
        },
        "north_star_hint": "整体功能完成率（已完成功能点数 / 总功能点数 × 100）",
        "health_dimensions": [
            {"name": "功能完成度", "color": "bg-violet-500"},
            {"name": "排期健康",   "color": "bg-amber-500" },
            {"name": "阻塞风险",   "color": "bg-emerald-500"},
            {"name": "代码质量",   "color": "bg-sky-500"   },
        ],
        "extra_fields": {
            "features": ["id", "module", "name", "status", "owner"],
            "devMetrics": ["totalFeatures", "doneFeatures", "activeFeatures", "weeklyPRsMerged", "p0Bugs"],
        },
    },
    "ops": {
        "label": "运营团队",
